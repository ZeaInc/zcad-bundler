...
class TreeItemView extends HTMLElement {
  ...
  constructor() {
    ...
    // const tailwindStyleTag = document.createElement("link");
    // tailwindStyleTag.href = "http://127.0.0.1:8080/styles/tailwind.min.css";
    // tailwindStyleTag.rel = "stylesheet";
    ...
    this.itemHeader.classList.add("text-white");
    ...
    this.expandBtn.className = "TreeNodesListItem__ToggleExpanded text-white";
  ...
  setTreeItem(treeItem, appData) {
    ...
    if (treeItem instanceof TreeItem) {
      ...
      this.toggleVisibilityBtn.className =
        "TreeNodesListItem__ToggleVisibility bg-transparent";

      this.itemHeader.insertBefore(this.toggleVisibilityBtn, this.titleElement);
      this.toggleVisibilityBtn.innerHTML =
        '<i class="material-icons-outlined md-15 text-white">visibility</i>';
  ...
  updateVisibility() {
    ...
    if (visible) {
      this.toggleVisibilityBtn.innerHTML =
        '<i class="material-icons-outlined md-15 pt-4 text-white">visibility</i>';
    } else {
      this.toggleVisibilityBtn.innerHTML =
        '<i class="material-icons-outlined md-15 pt-4 text-white">visibility_off</i>';
    }
  }
